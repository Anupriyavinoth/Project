...
def api_connect():
    api_id="AIzaSyBz1V3758aC4mF89JSq2c1qnc8AHr1lsq4"     
...
def get_channel_info(channel_id):
    ...
    for i in response['items']:
        ...
        return data
                    ...
                    #Quiz Blitz              : 'UCUBSTJf4MSrnohk1Ghc4Pcg'
                    #Detormentis             : 'UCL5MgQS6VbE9DOwi-R5Vh6w'
                    #Tamil Business Podcast  : 'UCy1lBBbXhtfzugF_LK2b6Yw'
                    #Quizzes4U               : 'UCI8-2jj_pV-6Ybj0lNLZLZg'
...
def get_playlist_details(channel_id):
    ...
    while True:
        ...
        next_page_token=response.get('pageInfo')  
        if next_page_token is None:
            break
        return all_data
...
client=pymongo.MongoClient("mongodb+srv://anu:1234@cluster0.fjjwrem.mongodb.net/?retryWrites=true&w=majority")
...
def channel_details(channel_id):
    ...
    collect1.insert_one({'channel_information':ch_details,'playlist_information':pl_details,
...
def channels_table():
  ...
  #Data converted to dataframe
    ...
    db=client["youtube_data"]
    collect1=db["channel_details"]
    for ch_data in collect1.find({},{"_id":0,"channel_information":1}):
...
def playlist_table():
    ...
    db=client["youtube_data"]
    collect1=db["channel_details"]
    for pl_data in collect1.find({},{"_id":0,"playlist_information":1}):
...
def videos_table():
    ...
    db=client["youtube_data"]
    collect1=db["channel_details"]
    for vi_data in collect1.find({},{"_id":0,"video_information":1}):
...
def comments_table():
    ...
    db=client["youtube_data"]
    collect1=db["channel_details"]
    for com_data in collect1.find({},{"_id":0,"comment_information":1}):
...
if question=="1. All the videos and  the channel name":
    ...
    mydb.commit()
    t3=cursor.fetchall()
    df3=pd.DataFrame(t3,columns=["views","channelname","video title"])
    st.write(df3)
